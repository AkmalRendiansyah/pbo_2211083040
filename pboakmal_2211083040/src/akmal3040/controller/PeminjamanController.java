 ...
 */
package akmal3040.controller;
import akmal3040.model.*;
import akmal3040.dao.*;
import akmal3040.database.DatabaseHelper;
import akmal3040.view.*;
   ...
   public void getPeminjaman(){
       try {
           ...
           String tglKembali = formPeminjaman.getTabelPeminjaman()
                   .getValueAt(formPeminjaman.getTabelPeminjaman().getSelectedRow(), 5).toString();
           
           
           peminjaman = peminjamanDao.getPeminjaman(nobp, kodeBuku, tglPinjam, tglKembali);
